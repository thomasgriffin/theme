...
<section class="section home columns columns-3 grid row">
	...
	<?php /*
	<div class="action">
		<a href="<?php echo site_url('blog'); ?>" class="button">Start Learning</a>
	</div>
	*/ ?>
</section>
...
<section class="section home alt3">
	<div class="wrapper">
		...
		<ul class="site-stats">
			<li>
				<a href="<?php echo site_url('category/member-restricted/free-members/'); ?>"><span class="total"><?php echo pp_get_category_post_count( 'free-members' ); ?></span> Free tutorials</a>
			</li>
			<li>
				<a href="<?php echo site_url('category/member-restricted/subscriber-only/'); ?>"><span class="total"><?php echo pp_get_category_post_count( 'subscriber-only' ); ?></span> Premium tutorials</a>
			</li>
			
			<li>
				<a href="<?php echo site_url('/products'); ?>"><span class="total"><?php echo pp_get_download_count(); ?></span> Products</a>
			</li>
			<li>
				<a href="<?php echo site_url('/blog'); ?>"><span class="total"><?php echo pp_get_post_count(); ?></span> Blog Posts</a>
			</li>
		</li>
	</div>
</section>
...
<section class="section home columns columns-3 grid row">
	...
	<header class="page-header">
		<h1>Learn from the best, for free</h1>
